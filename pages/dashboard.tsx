                ...
                {rows.map((row, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 space-x-2">
                      {editIndex === i ? (
                        <>
                          <button onClick={() => handleEditSave(i)} className="text-green-400">
                            💾
                          </button>
                          <button onClick={() => setEditIndex(null)} className="text-gray-400">
                            ✖️
                          </button>
                        </>
                      ) : (
                        <>
                          ...
                          <button onClick={() => handleDelete(row)} className="text-red-400">
                            🗑️
                          </button>
                        </>
                      )}
